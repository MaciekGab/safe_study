...
class DatabaseService {
  ...
  Future<String> updateUserData(
      String name, String surname, String role, String uid) async {
  ...
  Stream<UserModel> getUser(String id) => userCollection.doc(id).snapshots().map((snapshot) => UserModel.fromMap(snapshot.data()));
